...
DROP TABLE MC_SGV_CAT_VIDEO CASCADE CONSTRAINTS 
;

DROP TABLE MC_SGV_SAC CASCADE CONSTRAINTS 
;

DROP TABLE MC_SGV_VID_PROD CASCADE CONSTRAINTS 
;

DROP TABLE MC_SGV_VISU_VID CASCADE CONSTRAINTS 
;
